...
import { getAnnotationModalData, getDataForAnnotationModal } from "../../../store/slices/modals/selectors/selectors";
...
export const AnnotationModal: React.FC = () => {
  ...
  const { isOpen, product, card, keyPermission } = useAppSelector(getAnnotationModalData) as any;
